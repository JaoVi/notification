...
class Email {
    ...
    public function __construct() {
        ...
        $this->mail->Username = 'cursojoao@outlook.com';                     //SMTP username
        $this->mail->Password = 'joao1415';                               //SMTP password
        $this->mail->SMTPSecure = 'starttls';         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $this->mail->CharSet = 'utf-8';
        $this->mail->setLanguage('br');
        $this->mail->isHTML(true);
        $this->mail->Port = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
        $this->mail->setFrom('cursojoao@outlook.com', 'Equipe Joao');
    }
